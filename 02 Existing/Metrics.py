...
def PerformanceMetrics():
    def AY():  # dark
        ...
        plt.plot(num_Nodes_list, acc_list, color='#686bff', marker='s', mec='#2eff73', mfc="#fd3535", linestyle='-.', linewidth=2, label="Existing => Interpretable Medical Image Visual Question Answering Via Multi Modal Relationship Graph Learning")
    ...
    def PN():# light
        ...
        plt.plot(num_Nodes_list, pn_list, color='#910000', marker='o',markersize = 8,mec='#5653ff',mfc = "#ffa31a", linestyle='-.', linewidth=2,label='Existing => Interpretable Medical Image Visual Question Answering Via Multi Modal Relationship Graph Learning')
    ...
    def FS():# dark
        ...
        mpl_style(dark=True)
        plt.plot(num_Nodes_list, fs_list, color='#d364ff', marker='s', mfc='#ff0000', mec="#fffc58", linestyle='-.', linewidth=2, label='Existing => Interpretable Medical Image Visual Question Answering Via Multi Modal Relationship Graph Learning')
    ...
    def RL():  # dark
        ...
        plt.style.use('cyberpunk')
        bars = plt.bar(num_Nodes_list, rl_list, color='#00cad1', linestyle='-.', linewidth=2, label='Existing => Interpretable Medical Image Visual Question Answering Via Multi Modal Relationship Graph Learning')
    ...
    def LS():  # dark
        ...
        plt.style.use('cyberpunk')
        plt.plot(num_Nodes_list, ls_list, color='#ff68a7', marker='s', mec='#fffc2e', mfc="#35e6fd", linestyle='-.', linewidth=2, label="Existing => Interpretable Medical Image Visual Question Answering Via Multi Modal Relationship Graph Learning")
    ...
    def FNR():# light
        ...
        plt.style.use('Assets/Light.mplstyle')
        plt.plot(num_Nodes_list, tpr_list, color='#24d800', marker='o',markersize = 8,mec='#5653ff',mfc = "#1affd9", linestyle='-.', linewidth=2,label='Existing => Interpretable Medical Image Visual Question Answering Via Multi Modal Relationship Graph Learning')
    ...
    def FPR():# dark
        ...
        mpl_style(dark=True)
        plt.plot(num_Nodes_list, fpr_list, color='#e3ff64', marker='s', mfc='#ff0000', mec="#fffc58", linestyle='-.', linewidth=2, label='Existing => Interpretable Medical Image Visual Question Answering Via Multi Modal Relationship Graph Learning')
